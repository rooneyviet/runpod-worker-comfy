...
RUN mkdir -p models/checkpoints models/vae models/lora models/clip models/controlnet models/unet models/style_models models/clip_vision
...
RUN if [ "$MODEL_TYPE" = "sdxl" ]; then \
      ...
      wget --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/lora/enhanceaiteam-Flux-Uncensored-V2.safetensors https://huggingface.co/enhanceaiteam/Flux-Uncensored-V2/resolve/main/lora.safetensors && \
      wget --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/lora/strangerzonehf-Flux-Super-Realism-LoRA.safetensors https://huggingface.co/strangerzonehf/Flux-Animeo-v1-LoRA/resolve/main/Animeo.safetensors && \
      ...
      wget --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/lora/prithivMLmods-Canopus-LoRA-Flux-Anime https://huggingface.co/prithivMLmods/Canopus-LoRA-Flux-Anime/resolve/main/Canopus-Anime-Character-Art-FluxDev-LoRA.safetensors && \
      ...
      wget --header="Authorization: Bearer ${HUGGINGFACE_ACCESS_TOKEN}" -O models/clip_vision/sigclip_vision_patch14_384.safetensors https://huggingface.co/Comfy-Org/sigclip_vision_384/resolve/main/sigclip_vision_patch14_384.safetensors && \
